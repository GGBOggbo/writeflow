...
- [x] **Step 1: Write failing tests for exact entity preservation and fallback plans**
...
- [x] **Step 3: Implement the contract, Zod schema, normalization, and fallback**
...
- [x] **Step 1: Write failing prompt and provider tests**
...
- [x] **Step 3: Add `planTopicSearch` to `AIProvider`**
...
- [x] **Step 4: Run AI-focused tests and confirm GREEN**
...
- [x] **Step 3: Implement orchestration and progress events**
...
- [x] **Step 4: Run service/UI tests and confirm GREEN**
...
- [x] **Step 2: Run wxrank tests and confirm RED**
...
- [x] **Step 3: Implement deterministic relevance filtering**
...
- [x] **Step 4: Run wxrank tests and confirm GREEN**
...
- [x] **Step 1: Add a regression assertion for one credit operation**
...
- [x] **Step 3: Document the topic search flow**
